    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="max-w-7xl mx-auto py-8 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          ...
          {/* Tabs for Chat Rooms and Study Groups */}
          <Tabs defaultValue="chat-rooms" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-8">
              <TabsTrigger value="chat-rooms" className="text-lg py-3">
                💬 Quiz Discussion Rooms
              </TabsTrigger>
              <TabsTrigger value="study-groups" className="text-lg py-3">
                👥 Study Groups
              </TabsTrigger>
            </TabsList>

            <TabsContent value="chat-rooms" className="space-y-8">
              {/* Chat Rooms Grid */}
              {chatRooms.length === 0 ? (
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            ...
                            onClick={() => {
                              ...
                              console.log('Joining room:', room.quiz_id);
                            }}
                          >
                            Join Discussion
                          </Button>
